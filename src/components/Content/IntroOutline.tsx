...
export const IntroOutlineComp=({t, text, setText, tones, tone, setTone, brandVoices, brandVoice, setBrandVoice, minAge, setMinAge, maxAge, setMaxAge, languages, language, setLanguage}: any) => {
    return(
        <>
        <div>
