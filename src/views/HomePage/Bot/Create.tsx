      ...
      <div className={`flex justify-around mr-240`}>
        <div className='flex bg-white rounded-8 mt-20 p-24' style={{ "width": pxToVw(796), "height": pxToVw(441), boxShadow: '0px 2px 10px rgba(11.79, 0.59, 140.60, 0.04)', flexDirection: "column"}}>
            ...
            <div className='flex items-start justify-between' style={{display: "flex", flexDirection: "row"}}>
                ...
                <div className={`mt-12`}>
                    <Input.TextArea style={{resize: "none"}} styles={{ textarea: { width: pxToVw(368), height: pxToVw(228), fontSize: pxToVw(10) } }} placeholder={t('Company Introduction')}
            ...
            <div className='flex rounded-8 mt-12 justify-center items-center' 
                ...
                <div className={`mt-10`} style={{ color: "#000", opacity: 0.6, fontSize: pxToVw(10) }}>{ t("Upload all Product/Service Catalogs and FAQs") }</div>
                <div className={`mt-2`} style={{ color: "#000", opacity: 0.6, fontSize: pxToVw(10) }}>{ t("Drop PDF files here") }</div>
            </div> 
