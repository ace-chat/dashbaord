    ...
    <>
      ...
      >
        <div className={`flex justify-around`}>
          ...
          >
            {/* Topic start */}
            {props.optional?.topic && (
              <div>
                <div className={`flex items-center`}>
                  <Icon
                    name={`${countingNames[countingNames.length - 1]}`}
                    style={{ width: pxToVw(22), height: pxToVw(22) }}
                  />
                  <div className="hidden">{countingNames.pop()}</div>
                  <span
            ...
            {props.optional?.details && (
              <div className={`mt-24`}>
                ...
                <div className={`mt-12`}>
                  {/* brand name start */}
                  {props.optional?.details.brand_name && (
                    <div>
                      <Input
                        styles={{
                          input: {
                  ...
                  {props.optional?.details.service_name && (
                    <div className={`mt-12`}>
                      <Input
                        styles={{
                          input: {
                        ...
                        placeholder={t('Type Service/Product Name')}
                        value={productName}
                  ...
                  {props.optional?.details.service_desc && (
                    <div className={`mt-12`}>
                      <Input.TextArea
                        styles={{
                          textarea: {
            ...
            {props.optional?.style && (
              <div className={`mt-24`}>
                ...
                <div className={`mt-12`}>
                  ...
                  {/* voice start */}
                  {props.optional?.style.voice && (
                    <div className={`mt-12`}>
                      <Select
                        placeholder={
                          props.title === 'Match Brand Voice'
                            ? t('Brand Voice')
                            : t('Brand Voice (Optional)')
                        }
                        style={{
                          width: pxToVw(252),
                          height: pxToVw(36),
                        ...
                        options={brandVoices}
                        value={brandVoice}
                        onSelect={(value) => setBrandVoice(value)}
                        dropdownRender={(menu) => (
                          <>
                            <div>
                              <Button
                                ...
                                onClick={openBrandVoice}
                              >
                                <div
                                  className={`flex items-center justify-between`}
                                >
                                  <span style={{ fontSize: pxToVw(10) }}>
                                    {t('Create New')}
                                  </span>
                                  <div>
                                    <Icon
                          ...
                          return (
                            <>
                              ...
                              >
                                ...
                                <div
                                  onClick={() =>
                                    handleDelete(Number(option.value))
                                  }
                                >
                                  <Icon
                                    name={'trash'}
            ...
            {props.optional?.audience && (
              <div className={`mt-24`}>
                ...
                <div className={`mt-12`}>
                  {/* region start */}
                  {props.optional.audience.region && (
                    <div>
                      <Select
              ...
              <div className={`mt-24`}>
                ...
                <div className={`mt-12`}>
                  <Input.TextArea
                    ...
                    placeholder={t('Type Here (Optional)')}
                    value={details}
          ...
          {generatedText?.length == 0 ? (
            ...
            <div>
              <div
                className={`items-start justify-between rounded-10 mt-14 p-14`}
                style={{
              ...
              >
                ...
                >
                  <div
                    className={'pl-4 text-14 leading-28'}
                ...
                <div className={`flex items-center justify-end mt-24 self-end`}>
                  <div className={`w-78 flex items-center justify-between`}>
                    <div className={`cursor-pointer`}>
                      <Icon
                        name={'copied'}
                        style={{ width: pxToVw(15), height: pxToVw(15) }}
                      />
                    </div>
                    <div className={`cursor-pointer`}>
                      <Icon
          ...
          <CreateBrandVoice
            open={open}
            confirm={confirmBrandVoice}
            cancel={cancelBrandVoice}
          />
          <DeleteVoice
            onConfirm={onConfirm}
            onCancel={onCancel}
