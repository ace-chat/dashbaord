  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-start">
        <div className={`text-22`}>{t(dialog.title)}</div>
        <div className={`text-12 text-[#767676] mt-5`}>{t(dialog.desc)}</div>
        {dialog.step === 1 && (
          <>
            <Input
              styles={{
            ...
            <div
              className={`w-full bg-[#F5F5FB] p-18 rounded-9 text-16 text-[#767676] my-15`}
            >
              {desc}
            </div>

            <div
              className={`w-full bg-[#F5F5FB] p-18 rounded-9 text-16 text-[#767676]`}
            >
              {voice}
            </div>
          </>
        ...
        {dialog.step === 0 && (
          <>
            <Input.TextArea
              ...
              className={`w-648 !h-294 text-10 bg-[#F4F6FA] border-0 mt-30`}
              placeholder={t(
