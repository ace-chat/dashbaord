            ...
            <div className={`flex justify-between`}>
                ...
                <div className={`flex p-24 flex-col`} style={{ width: pxToVw(500) }}>
                    ...
                    <div className={`mt-12`}>
                        ...
                        style={{"backgroundColor": "white", "display": "flex", "width": pxToVw(400), "height": pxToVw(293), border: "1px solid #DBDBDB", flexDirection: "column" }}
                        >
                          {selectedFiles.map((file: any, index: number) => {
                            return(
                                <div className='flex flex-col items-center' key={index} style={{ marginTop: pxToVw(10), alignSelf: "self-start", paddingLeft: pxToVw(10)}}>
                                    <Icon name='pdf' style={{ width: pxToVw(45), height: pxToVw(45), alignSelf: "center" }} />
                                    <div style={{ fontFamily: "PingFang SC Medium", fontSize: pxToVw(6), color: "#818181", marginTop: pxToVw(5) }}>{file?.name}</div>
                                </div>
                            )
                          })}
                        </div> 
...
<div className={`mt-12`}>
    <div className='flex rounded-8 mt-16 justify-center items-center' 
    style={{"backgroundColor": "#F4F6FA", "display": "flex", "width": pxToVw(400), "height": pxToVw(356), border: "1px dashed #8B8B8B", flexDirection: "column" }}
    onClick={() => fileInput.current.click()}>
        <input
            type="file"
            id="fileInput"
